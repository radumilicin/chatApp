...
async function insertUsers() {
    var nr_users = await new Promise((resolve) => {
...
async function insertContacts() {
    var nr_contacts = await new Promise((resolve) => {
...
async function insertImages() {
    try {
        ...
        // Ask for image path
        var image_path = await new Promise((resolve) => {
...
async function insertMessages(curr_user) {
    try {
        // Ask to what user we are adding the image
        var user_id = await new Promise((resolve) => {
        ...
        // Ask for image path
        var recipient_id = await new Promise((resolve) => {
