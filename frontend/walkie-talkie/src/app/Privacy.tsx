...
export function ProfilePicturePrivacy(props: any) {
    ...
    return (
        <div className={`relative flex flex-row top-[4%] left-[6%] w-[88%] h-[12%] rounded-xl ${props.themeChosen === "Dark" ? "hover:bg-[#ACCBE1]" : "hover:bg-gray-500 border-[2px] border-gray-600"} hover:bg-opacity-40 hover:cursor-pointer`}
...
export function BlockedContacts(props: any) {
    ...
    return (
        <div className={`relative flex flex-row top-[6%] left-[6%] w-[88%] h-[12%] rounded-xl ${props.themeChosen === "Dark" ? "hover:bg-[#ACCBE1]" : "hover:bg-gray-500 border-[2px] border-gray-600"} hover:bg-opacity-40 hover:cursor-pointer`}
