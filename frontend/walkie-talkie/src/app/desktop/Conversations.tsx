    ...
    return (
        <div className={`absolute left-0 top-0 h-[6.5%] min-w-[50px] w-[98%] flex flex-row items-center`}>
            ...
            <div className="relative left-[30%] w-[20%] h-full flex flex-row items-center">
                ...
                <div className={`relative left-0 w-[50%] h-8 transition-all ${props.themeChosen === "Dark" ? "hover:bg-[#3B7E9B]/20 hover:shadow-lg hover:shadow-[#3B7E9B]/30" : "hover:bg-opacity-30"} hover:rounded-xl flex flex-row items-center justify-center hover:cursor-pointer`} onClick={() => {props.setMenuPress(true)}}>
    ...
    return (
        <div className={`absolute left-0 top-0 w-full h-full backdrop-blur-xl`}>
            ...
            {!finishingSettingUpGroup && <div className={`relative flex top-0 flex-col w-full ${props.contactsInNewGroup.length !== 0 ? 'h-[55%]' : 'h-[70%]' } justify-start items-center overflow-y-scroll scrollbar-hidden`}>
                ...
                <div
                    key={idx}
                    className={`group/groupuser relative flex-none flex flex-row h-[15%] w-[92%] mt-2 top-0 overflow-hidden
                        transition-all duration-300 rounded-xl hover:cursor-pointer
                        ${props.themeChosen === "Dark"
