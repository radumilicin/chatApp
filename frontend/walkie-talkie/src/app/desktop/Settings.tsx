...
export function Settings(props) {
    ...
    return (
        <div className="relative flex flex-col h-[50%] rounded-bl-2xl w-full min-w-[50px] min-h-[200px]">
            <div className="relative flex flex-col mt-auto mb-2 min-w-[50px] gap-2">
                <div className="relative flex flex-col w-full top-0 basis-[1/5] min-h-[60px]  items-center justify-center">
                    <div
                    ...
                    >
                        ...
                        className="w-4 h-4 md:w-[28px] md:h-[28px] xl:w-[32px] xl:h-[32px]
                ...
                <div className="relative flex flex-col w-full basis-[1/5] top-0 min-h-[60px] items-center justify-center hover:cursor-pointer" onClick={() => {props.setPressProfile(true)}}>
                    <div className={`flex w-[44px] h-[44px] justify-center items-center flex-col rounded-xl transition-all ${props.themeChosen === "Dark" ? "hover:bg-[#3B7E9B]/20 hover:shadow-lg hover:shadow-[#3B7E9B]/30" : "hover:bg-gray-300/50"} hover:scale-105 active:scale-95`}>
