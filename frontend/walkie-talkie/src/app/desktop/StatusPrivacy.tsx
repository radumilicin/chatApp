    ...
    return (
        <div className={`relative left-[8%] w-[30%] top-[5%] h-[90%] ${props.themeChosen === "Dark" ? "bg-[#323232] bg-opacity-60 border-[#0D1317] " : "bg-gray-300 border-gray-400 shadow-lg border-2"} border-black border-2 flex flex-col`}>
            <div className={`absolute left-[2%] top-[0%] h-[6%] w-[98%] flex flex-row ${props.themeChosen === "Dark" ? "bg-gray-800 bg-opacity-30" : "bg-transparent"}`}>
                <div className={`relative indent-[10px] top-[15%] h-full left-[2%] w-[8%] text-2xl font-semibold text-black font-sans flex flex-row justify-center items-center ${props.themeChosen === "Dark" ? "hover:bg-opacity-40" : "hover:bg-opacity-30"} hover:rounded-xl hover:cursor-pointer`}
                        onClick={() => {
                    ...
                    <div className={`flex flex-row w-[90%] h-[70%] justify-center items-center hover:bg-gray-500 hover:rounded-xl ${props.themeChosen === "Dark" ? "hover:bg-opacity-40" : "hover:bg-opacity-30"} hover:rounded-xl hover:cursor-pointer`}>
                ...
                <div className={`relative indent-[10px] top-[15%] left-[2%] w-[90%] text-base lg:text-lg xl:text-xl font-semibold ${props.themeChosen === "Dark" ? "text-white" : "text-black"} font-sans flex flex-row justify-start items-center`}>Status privacy</div>
            </div>
