...
export default function ProfileInfoVertical( props ) {
    ...
    return (
        <div className={`relative top-0 left-0 w-full h-[90%] ${props.themeChosen === "Dark" ? "bg-[#323232] bg-opacity-60 border-[#0D1317] " : "bg-gray-300 border-gray-400 shadow-lg border-2"} border-2 border-[#0D1317] rounded-r-xl flex-col overflow-y-scroll scrollbar-hidden`}>
