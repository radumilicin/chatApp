        ...
        <div className={`relative left-0 w-full top-0 h-[90%] ${props.themeChosen === "Dark" ? "bg-[#323232] bg-opacity-60 border-[#0D1317] " : "bg-gray-300 border-gray-400 shadow-lg border-2"} border-black border-2 flex flex-col`}>
            ...
            <div className="absolute left-0 w-full top-[15%] h-[70%] flex flex-col items-center">
                <div className="relative top-0 left-0 flex flex-col w-full h-full gap-4">
                    <div className={`relative flex flex-row h-[6%] left-[6%] w-[96%] text-base xss:text-lg ${props.themeChosen === "Dark" ? "text-[#CBD4E0]" : "text-black"}`}>Who can see your status:</div>
                        ...
                        <div className="relative flex flex-row w-full h-[20%]">
                            <div className="relative flex flex-row justify-center items-center w-[10%] h-full">
                                <div className="relative flex flex-row justify-center items-center w-6 h-6 hover:cursor-pointer" onClick={() => { props.setVisibilityStatus("Everyone") }}>
                                    {props.visibilityStatus !== "Everyone" && <div className="absolute flex flex-row w-5 h-5 xss:w-6 xss:h-6 bg-transparent border-[3px] border-gray-700 rounded-full"></div>}
                                    {props.visibilityStatus === "Everyone" && <div className="absolute flex flex-row w-2 h-2 xss:w-3 xss:h-3 bg-green-500 rounded-full"></div>}
                                    {props.visibilityStatus === "Everyone" && <div className="absolute flex flex-row w-5 h-5 xss:w-6 xss:h-6 bg-transparent border-[2px] xss:border-[3px] border-green-500 rounded-full"></div>}
                                </div>
                            </div>
                        ...
                        <div className="relative flex flex-row w-full h-[20%]">
                            <div className="relative flex flex-row justify-center items-center w-[10%] h-full">
                                <div className="relative flex flex-row justify-center items-center w-6 h-6 hover:cursor-pointer" onClick={() => { props.setVisibilityStatus("Contacts") }}>
                                    {props.visibilityStatus !== "Contacts" && <div className="absolute flex flex-row w-5 h-5 xss:w-6 xss:h-6 bg-transparent border-[3px] border-gray-700 rounded-full"></div>}
                                    {props.visibilityStatus === "Contacts" && <div className="absolute flex flex-row w-2 h-2 xss:w-3 xss:h-3 bg-green-500 rounded-full"></div>}
                                    {props.visibilityStatus === "Contacts" && <div className="absolute flex flex-row w-5 h-5 xss:w-6 xss:h-6 bg-transparent border-[2px] xss:border-[3px] border-green-500 rounded-full"></div>}
                                </div>
                            </div>
                        ...
                        <div className="relative flex flex-row w-full h-[20%]">
                            <div className="relative flex flex-row justify-center items-center w-[10%] h-full">
                                <div className="relative flex flex-row justify-center items-center w-6 h-6 hover:cursor-pointer" onClick={() => { props.setVisibilityStatus("Nobody") }}>
                                    {props.visibilityStatus !== "Nobody" && <div className="absolute flex flex-row w-5 h-5 xss:w-6 xss:h-6 bg-transparent border-[3px] border-gray-700 rounded-full"></div>}
                                    {props.visibilityStatus === "Nobody" && <div className="absolute flex flex-row w-2 h-2 xss:w-3 xss:h-3 bg-green-500 rounded-full"></div>}
                                    {props.visibilityStatus === "Nobody" && <div className="absolute flex flex-row w-5 h-5 xss:w-6 xss:h-6 bg-transparent border-[2px] xss:border-[3px] border-green-500 rounded-full"></div>}
                                </div>
                            </div>
